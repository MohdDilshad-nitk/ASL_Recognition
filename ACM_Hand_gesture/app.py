    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if len(res) == 200:
                    if(keypoint_classifier_labels[Counter(
                            res).most_common(1)[0][0]] == 'not recognised'):
                        None
                    else:
                        string = string + \
                        keypoint_classifier_labels[Counter(
        ...
        debug_image = draw_info(debug_image, mode, number, string, timeleft)
...
def draw_info(image, mode, number, string, timeleft):
    ...
    cv.putText(image, "FPS:" + str(string), (10, 30), cv.FONT_HERSHEY_SIMPLEX,
